 ...
 *   - timing:  R1 (Q1-20) = 10s / question, R2 (Q21-40) = 30s,
 *     R3-4 (Q41-80) = 30s, R5 (Q81-100) = 45s
...
export const TEST_QUESTIONS: QuestionItem[] = [
  ...
  },
  {
    ...
    roundName: "Computer & IT Basics",
    points: 1,
    questionText: "Which key is commonly used to delete characters to the left of the cursor?",
    optionA: "Shift",
    optionB: "Ctrl",
    optionC: "Backspace",
    optionD: "Alt",
  ...
  },
  {
    ...
    roundName: "Internet, Web & Digital World",
    points: 1,
    questionText: "Which protocol is commonly used for secure websites?",
    optionA: "HTTP",
    optionB: "HTTPS",
    optionC: "FTP",
    optionD: "SMTP",
  ...
  },
  {
    ...
    roundName: "Internet, Web & Digital World",
    points: 1,
    questionText: "Which language is mainly used to structure web pages?",
    optionA: "HTML",
    optionB: "SQL",
    optionC: "Python",
    optionD: "C++",
  ...
  },
  {
    ...
    roundName: "Internet, Web & Digital World",
    points: 1,
    questionText: "What does downloading mean?",
  ...
  },
  {
    ...
    roundName: "Internet, Web & Digital World",
    points: 1,
    questionText: "What does \"online\" generally mean?",
  ...
  },
  {
    ...
    optionB: "Increases monitor size",
  ...
  },
  {
    ...
    optionA: "Technology that enables computers to perform tasks associated with human intelligence",
  ...
  },
  {
    ...
    optionB: "Check your internet connection",
  ...
  },
  {
    ...
    roundName: "The Hackathon Challenge",
    points: 3,
    questionText: "Which HTTP method is normally used to retrieve information from a server?",
    optionA: "GET",
    optionB: "POST",
    optionC: "DELETE",
    optionD: "PATCH",
  ...
  },
  {
    ...
    roundName: "The Hackathon Challenge",
    points: 3,
    questionText: "Which version-control tool is widely used by developers?",
    optionA: "Git",
    optionB: "Paint",
    optionC: "Calculator",
    optionD: "Notepad",
